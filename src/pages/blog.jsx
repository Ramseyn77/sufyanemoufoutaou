...
const Blog = () => {
  ...
  if (selected) {
    return (
      <div className="flex flex-col w-full min-h-screen bg-[#F8FAFC] dark:bg-[#0D1B2A]">
        <Navbar />
        ...
        <div className="px-4 py-6">
          <div className="max-w-4xl mx-auto flex flex-col gap-6">
            <button
              ...
              className="inline-flex items-center gap-2 text-xs font-medium text-indigo-500 dark:text-blue-400 hover:underline self-start"
            >
              <span>Retour aux articles</span>
            </button>

            <div className="relative overflow-hidden rounded-[28px] border border-slate-200/80 dark:border-slate-700/60 bg-white dark:bg-[#1B263B] p-6 md:p-8 shadow-[0_20px_50px_-35px_rgba(15,23,42,0.35)]">
              ...
              <div className="relative flex flex-col gap-5">
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <span className="text-[11px] uppercase tracking-[0.18em] text-amber-500 dark:text-amber-400 font-semibold">
                    Article
                  </span>
                </div>
            ...
            <div className="rounded-[28px] border border-slate-200/80 dark:border-slate-700/60 bg-white dark:bg-[#1B263B] p-6 md:p-8 shadow-[0_18px_45px_-35px_rgba(15,23,42,0.3)]">
              <div className="prose prose-sm max-w-none text-slate-700 dark:text-slate-300 leading-8">
                {selected.contenu}
              </div>
            </div>
          </div>
    ...
    <div className="flex flex-col w-full min-h-screen bg-[#F8FAFC] dark:bg-[#0D1B2A]">
      ...
      <div className="px-4 py-6 flex flex-col gap-8">
        <div className="max-w-6xl mx-auto w-full flex flex-col gap-8">
          <div className="relative overflow-hidden rounded-[28px] border border-slate-200/80 dark:border-slate-700/60 bg-white dark:bg-[#1B263B] px-6 py-8 md:px-8 md:py-10 shadow-[0_20px_50px_-35px_rgba(15,23,42,0.35)]">
            ...
            <div className="relative flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div className="flex flex-col gap-2 max-w-2xl">
                <span className="text-[11px] uppercase tracking-[0.22em] text-amber-500 dark:text-amber-400 font-semibold">
                  Journal
                </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {data.blogs.map((article, index) => (
              <button
                ...
                className="group relative overflow-hidden flex min-h-[260px] flex-col rounded-[24px] border border-slate-200/80 dark:border-slate-700/60 bg-white dark:bg-[#1B263B] p-5 text-left shadow-[0_18px_45px_-35px_rgba(15,23,42,0.35)] transition duration-300 hover:-translate-y-1 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-[0_24px_50px_-35px_rgba(15,23,42,0.4)]"
              >
                <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-amber-400 via-amber-300 to-blue-400 opacity-80" />
                ...
                <div className="relative flex flex-col gap-4 h-full">
                  ...
                  <div className="pt-3 border-t border-slate-200 dark:border-slate-700 flex items-center justify-between">
                    ...
                    <span className="inline-flex items-center gap-2 text-sm font-semibold text-indigo-500 dark:text-blue-400">
                      Ouvrir
